...
/*
 * This header file was automatically @generated for the widerfaceonet network from a template.
...
/*
  SUMMARY OF OPS
  Hardware: 13,226,592 ops (12,905,728 macc; 320,864 comp; 0 add; 0 mul; 0 bitwise)
    ...
    Layer 4: 131,328 ops (131,072 macc; 256 comp; 0 add; 0 mul; 0 bitwise)
    Layer 5: 1,280 ops (1,280 macc; 0 comp; 0 add; 0 mul; 0 bitwise)

  RESOURCE USAGE
  Weight memory: 262,240 bytes out of 442,368 bytes total (59.3%)
